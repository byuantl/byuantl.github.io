...
- {{< card 
    href="/projects/lna" 
    image="/projects/lna/lna.png" 
  >}}
  **45nm Low Noise Amplifier**

  Fully-integrated CMOS Low Noise Amplifier (gpdk045) for 5.25 GHz wireless applications. Analyzed noise and linearity + input/output impedance matched.
  {{< /card >}}
